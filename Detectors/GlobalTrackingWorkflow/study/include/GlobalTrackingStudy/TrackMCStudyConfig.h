...
struct TrackMCStudyConfig : o2::conf::ConfigurableParamHelper<TrackMCStudyConfig> {
  ...
  bool requireTopBottomRefs = true;
  int minTPCRefsToExtractClRes = 5;
  float rejectClustersResStat = 0.8;
  float maxTPCRefExtrap = 10; // max dX to extrapolate the track ref when extrapolating track true posions
