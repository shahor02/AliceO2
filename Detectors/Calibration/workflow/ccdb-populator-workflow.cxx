...
/* I think I don't need this, since the options are in the spec, correct?
void customize(std::vector<o2::framework::ConfigParamSpec>& workflowOptions)
{
  // option allowing to set parameters
  workflowOptions.push_back(ConfigParamSpec{"ccdb-path", o2::framework::VariantType::String, "http://ccdb-test.cern.ch:8080", {"Path to CCDB"}});
}
*/
